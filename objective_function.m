...
% -------------------------------------------------------------------------
% function from the DIRECTGOLib: https://github.com/blockchain-group/DIRECTGOLib
...
%   Continuous, Non-differentiable, Separable, Scalable, Multi-modal,
...
if nargin == 0
    ...
    y.features = [1, 0, 1, 1, 1, 0, 0, 1, 1];
    y.libraries = [1, 1, 1, 0, 1, 1, 0, 1];
    return
end
